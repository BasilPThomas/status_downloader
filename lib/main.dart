...
import 'package:status_downloader/includes/myNavigationDrawer.dart';
...
class _MyAppState extends State {
  ...
  Future checkReadPermission() async {
  ...
  Future checkWritePermission() async {
  ...
  Future requestReadPermission() async {
